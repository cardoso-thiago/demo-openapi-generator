 ...
 * 1) Set a break point in SpringCustomGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class SpringCustomGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("spring-custom") // use this codegen library
              ...
              .setOutputDir("out/spring-custom"); // output directory
